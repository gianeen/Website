...
```
So- you're graduating in 13 days, you want to express some gratitude to the people you've met along the way these past for years during your time on the 40 Acres, and you have a project due in 5 days and have to demonstrate to your professor that you know the power in using Python and R together.

Have no fear! Today I'm going to show you how you can do just that. *"But Gianeen, why not just use R or Python exclusively?"* Well, person-who-is-reading-this. If you're going to code, or even teach someone how to code, chances are, you will be required to use more than one language. It's just like providing healthcare services in the state of Texas- knowing Spanish and English is an advantage- just like knowing *both* R and Python is an advantage in the coding world! 
...
Danny:
```{python}
danny= "thinking I'm funny. Seriously. I didn't think I was cool until I realized how much you laughed at everything I said. HAHA just kidding. Thank you for always being such a joy to be around. You've always been so reliable and trustworthy and I know I can come to you for anything. I'm going to miss seeing your science pun t-shirts and sharing Bob with you after LA meetings."
print(r.ty,danny)
```
Felipe:
```{python}
...
Phoebe:
```{python}
phoebe= "so much. So so much. I honestly don't even know where to begin. Through all our shared experiences (the lab, the UCC, past roomies) we continue to grow closer and more trusting of each other. Thank you for creating a safe space where I can be vulnerable. You are an expert at creating a welcoming and comfortable environment for anyone and everyone, especially me. Your grit, resilience, and desire to always be inclusive is going to take you so far. I'm so excited to see where life takes you. Love you forever!"
print(r.ty,phoebe)
```
Zoe:
```{python}
