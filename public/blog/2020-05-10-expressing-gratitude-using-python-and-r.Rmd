...
Now, I'm going to integrate R and Python together using the python function 'print()', inserting the following text within the round brackets "*r.r code* , *python code*": 
```{python}
print(r.ty,rachel)
```
