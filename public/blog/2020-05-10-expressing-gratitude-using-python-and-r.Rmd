...
```
So- you're graduating in 13 days, you want to express some gratitude to the people you've met along the way during your past four years in college, and you have a project due in 5 days and have to demonstrate to your professor that you know the power in using Python and R together.
...
First, I used 'ol reliable, RStudio. I figured since I'm thanking everyone, I might as well start off every message of gratitude with "thank you for". 
```{R}
library(reticulate)
ty<-"Thank you for"
```
...
Now, I'm going to integrate R and Python together using the python function 'print(), integrating R text using "r.*r code here*",*python code here*)
```{python}
print(r.ty,rachel)
```
![](https://drive.google.com/file/d/17ibfeSsNiG6PuzGY5IaDmc6oavJANSov/view?usp=sharing)
